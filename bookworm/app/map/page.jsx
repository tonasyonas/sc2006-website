...
export default function MapPage() {
  ...
  useEffect(() => {
    const getLibData = async () => {
      try {
        const res = await fetch("api/librarydata");
    ...
    getLibData()
      .then(res => {
        ...
        //     libOpenHours: "Mon - Sun: 10:00 AM - 09:00 PM",
        //   },
        const parsed_libs = libraries.map(lib => {
          return {
            libName: lib.title,
            libAddress: lib.address,
            libCoords: lib["georss:point"].split(" "),
            libOpenHours: lib.operatingHours,
          };
        });
        setLibData(parsed_libs);
      })
